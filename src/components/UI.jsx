...
export const UI = ({ hidden, text, setText }) => {
  const input = useRef();
    ...
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
        <div
          ...
          } bg-gray-800 border-2 border-gray-600 rounded-md p-4 text-white overflow-y-scroll pointer-events-auto shadow-lg transition-all duration-300`}
        >
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-bold text-center text-pink-500">
              Report Analyzer
            </h2>
            <button
